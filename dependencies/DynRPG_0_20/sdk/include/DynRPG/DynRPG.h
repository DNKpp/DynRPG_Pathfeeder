...
extern "C" {
	...
	*/
	...
	/*! \brief Called before an event command is executed
		...
		The "don't execute if you return \c false" feature works by setting bit
	...
	*/
	...
	/*! \brief Called before a battler's action is executed
		...
		\sa RPG::Action
	*/
	bool __declspec(dllexport) __cdecl onDoBattlerAction(RPG::Battler *battler);
	...
	*/
	...
	/*! \brief Called after the system background was drawn
		...
		\note In the save/load menu, there is only the smart part at the top
